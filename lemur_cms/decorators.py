...
"""
General-purpose decorators for use with LemurCMS.
"""
...
def require_auth(view_func):
    ...
    :exc:`~lemur_cms.exceptions.NotAuthenticated` exception if the user is not
    signed-in.
    """
    from lemur_cms.exceptions import NotAuthenticated  # noqa
